...
public class Process_1 {
	...
	public static void main(String[] args) throws IOException {
        ...
        config.addResource(new Path("/home/leomora/Development/hbase-0.94.10/conf/hbase-site.xml"));
        //HBaseConfiguration config = new HBaseConfiguration();
        //config.clear();
        //config.set("hbase.zookeeper.quorum", "127.0.0.1");
        //config.set("hbase.zookeeper.property.clientPort","2181");
        //config.set("hbase.master", "localhost:7439");
...
//		// the below, we are converting the String "user1" into a byte
...
//		 
//		// To set the value you'd like to update in the row 'user1',
...
//		// arrays. Lets pretend the table 'Globant' was created
